export declare const systemResources: {
    records: {
        _reportSettings: import("./design").SimpleRecord;
    };
    messages: {
    ...
    valueLists: import("./common").StringMap<import("./design").ValueList>;
    valueSchemas: import("./common").StringMap<import("./design").ValueSchema>;
};
